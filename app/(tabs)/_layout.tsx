            ...
            <View style={[styles.progressCard, { backgroundColor: colors.background, borderColor: colors.border }]}>
              ...
              <View style={styles.progressBarContainer}>
                <View style={[styles.progressBar, { backgroundColor: colors.border }]}>
                  <View 
                    style={[styles.progressFill, { width: `${progress.percentage}%`, backgroundColor: colors.success }]} 
                  />
                </View>
              </View>
            </View>
        ...
        <View style={styles.addSection}>
          {modalState === 'none' ? (
            <View style={styles.addButtonsContainer}>
              <TouchableOpacity
                style={[styles.complexTaskButton, { backgroundColor: '#7C3AED' }]}
            ...
            <View style={[styles.addInputCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              <TextInput
      ...
      >
        ...
        <View style={styles.taskInfo}>
            ...
            <View style={styles.taskMeta}>
              {task.startTime && (
                <View style={styles.metaItem}>
                  ...
                  <Text style={[styles.metaText, { color: colors.textSecondary }]}>{formatTime(task.startTime)}</Text>
                </View>
              )}
              
              {task.duration && (
                <View style={styles.metaItem}>
                  <Text style={[styles.metaText, { color: colors.textSecondary }]}>{task.duration}min</Text>
                </View>
              )}
          ...
          {task.subtasks && task.subtasks.length > 0 && (
            <View style={[styles.subtasksContainer, { borderTopColor: colors.borderLight }]}>
